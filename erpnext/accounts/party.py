...
def get_dashboard_info(party_type, party, loyalty_program=None):
	...
	if party_type != "Company":
		...
		company_wise_grand_total = frappe.get_all("Sales Invoice",
			filters={
				'docstatus': 1,
				'company': party,
				'posting_date': ('between', [current_fiscal_year.year_start_date, current_fiscal_year.year_end_date])
		...
		info = {}
		info["billing_this_year"] = float(company_wise_grand_total[0].base_grand_total) if company_wise_grand_total[0].base_grand_total else 0
		...
		company_wise_grand_total = frappe.get_all("Purchase Invoice",
			filters={
				'docstatus': 1,
				'company': party,
				'posting_date': ('between', [current_fiscal_year.year_start_date, current_fiscal_year.year_end_date])
