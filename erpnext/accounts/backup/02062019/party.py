...
#	frappe.msgprint(_("Companies is {0} and Companies_2 is {1}").format(companies, companies_2))
	...
	frappe.msgprint(_("company_wise_grand_total before adding 100 is {0}").format(company_wise_grand_total))
	...
	company_wise_total_unpaid_not_dict = frappe.db.sql("""
	...
	frappe.msgprint(_("company_wise_total_unpaid is {0} and company_wise_total_unpaid_not_dict is {1}").format(company_wise_total_unpaid, company_wise_total_unpaid_not_dict))
